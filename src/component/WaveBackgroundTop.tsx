export default function WaveBackgroundTop() {
    return (
        <div className="relative h-[120px] w-full sm:h-[180px] lg:h-[266px]">
            {/* Jaune clair - en dessous */}
            <svg className="absolute left-0 top-0 h-auto w-[220px] sm:w-[320px] lg:w-[484px]" viewBox="0 0 484 266" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className="absolute left-0 top-0 h-auto w-[170px] sm:w-[230px] lg:w-[312px]" viewBox="0 0 312 125" fill="none" xmlns="http://www.w3.org/2000/svg">
